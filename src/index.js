              ...
              render={() => {
                return (
                  <React.Fragment>
                    ...
                    <Button ugly onClick={button =>
                        (window.location.href = "https://raw.githubusercontent.com/chromebot-websites/chromebot.cf/master/public/images/2AA15818-B987-4253-AA6B-74BBE74173D6.jpeg")
                      }> 10/10 best button</Button>
                  </React.Fragment>
                );
              }}
            />
